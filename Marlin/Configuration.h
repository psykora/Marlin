...
#define MACHINE_UUID "2d4db691-94d5-4322-9e6e-1f8a1e385355"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 266.5 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 292.3 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  // 176.5 - 42 - 14
  #define DELTA_RADIUS 133.2 //mm  Get this value from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 160, 98 }  // default steps per unit for Kossel (GT2, 20 tooth)
